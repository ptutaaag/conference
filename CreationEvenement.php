...
if (isset($_POST['nomEvenement']) == false && isset($_POST['contenuEvenement']) == false && isset($_POST['lieuEvenement']) == false && isset($_POST['dateDebut']) == false && isset($_POST['dateFin']) == false) {
...
<div id='creationEvenement'>
        ...
        <span class ='error'> Veuillez remplir tout les champs </span>
